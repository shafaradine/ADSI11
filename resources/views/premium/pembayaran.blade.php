    ...
    <div class="isolate bg-white">
        ...
        <main>
            <div class="px-20 pb-10">
                <div class="font-bold text-center normal-case text-2xl px-10 pb-10">Berlangganan AmbisYuk Premium</div>
                <div class="grid grid-cols-2 gap-16">
                    <div>
                        <p class="mb-5 font-bold text-lg">Paket yang kamu pilih</p>
                        <div style="background-color:#81B29A" class="card w-full shadow-xl border">
                            <div class="card-body">
                                <h2 class="card-title font-bold text-2xl text-info-content mx-auto">Rp99.999</h2>
                                <p class="text-center">akses 1 bulan
                                    nikmati seluruh fitur premium
                                    terhubung dengan tutor professional </p>
                            </div>
                        </div>
                        <p class="py-5 font-bold text-lg">Akses yang kamu dapatkan</p>
                        <div class="card w-full bg-base-200 shadow-xl border">
                            <div class="card-body">
                    ...
                    <div>
                        <p class="mb-5 font-bold text-lg">Pilih Metode Pembayaran</p>
                        <p class="mb-5 text-md">Untuk melanjutkan pesananmu, ayo pilih metode pembayaran sesuai keinginanmu</p>
                        ...
                        <div class="grid-cols-2 grid gap-4 mt-20">
                            <p style="color:#81B29A" class="font-bold text-base">Metode Pembayaran</p>
                            <p class="font-bold text-base flex justify-end">Gopay</p>
