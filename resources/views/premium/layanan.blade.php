    ...
    <div class="isolate bg-white">
        ...
        <main>
            <div class="px-20 pb-10">
                <div class="font-bold text-center normal-case text-2xl px-10 pt-5 pb-3">KAMU BELUM BERLANGGANAN</div>
                <div class="font-medium text-center normal-case text-lg px-10">ayo pilih paket yang kamu inginkan</div>
                <div class="grid grid-cols-3 gap-4 py-5">
                    <div class="card w-full bg-base-100 shadow-xl border">
                        <div class="card-body">
                            <h2 class="card-title font-bold text-2xl text-info-content mx-auto">Rp399.999</h2>
                            <p class="text-center">akses 12 bulan
                                nikmati seluruh fitur premium
                                terhubung dengan tutor professional </p>
                            <div class="card-actions justify-center">
                                <button class="btn rounded-full w-48 bg-info-content mt-5">Berlangganan</button>
                            </div>
                        </div>
                    </div>
                    <div class="card w-full bg-base-100 shadow-xl border">
                        <div class="card-body">
                            <h2 class="card-title font-bold text-2xl text-info-content mx-auto">Rp299.999</h2>
                            <p class="text-center">akses 4 bulan
                                nikmati seluruh fitur premium
                                terhubung dengan tutor professional </p>
                            <div class="card-actions justify-center">
                                <button class="btn rounded-full w-48 bg-info-content mt-5">Berlangganan</button>
