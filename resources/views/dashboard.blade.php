...
<body>
                    ...
                    <div>
                        <div>
                            ...
                            <div class="mt-8 flex gap-x-4 sm:justify-center">
                                <a href="#" class="inline-block rounded-lg bg-info-content px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-base-300 hover:bg-info-content-700 hover:ring-info-content-700">
                                    Get started
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#B1C9BD" fill-opacity="1" d="M0,224L48,224C96,224,192,224,288,202.7C384,181,480,139,576,144C672,149,768,203,864,208C960,213,1056,171,1152,170.7C1248,171,1344,213,1392,234.7L1440,256L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
    </svg>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#B1C9BD" fill-opacity="1" d="M0,224L48,224C96,224,192,224,288,202.7C384,181,480,139,576,144C672,149,768,203,864,208C960,213,1056,171,1152,170.7C1248,171,1344,213,1392,234.7L1440,256L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
    </svg>

    <!--menu-->
    <div class="lg:px-20 sm:px-5 py-10">
        <div class="grid lg:grid-cols-4 sm:grid-cols-1 gap-4 justify-items-center pb-10 mx-auto">
            <div class="card card-side bg-base-100 shadow-xl border h-36 w-full">
                <figure><img src="/public/img/a.jpg" alt="Movie" /></figure>
                <div class="card-body">
            ...
            <div class="card card-side bg-base-100 shadow-xl border h-36 w-full">
                <figure><img src="/public/img/b.jpg" alt="Movie" /></figure>
                <div class="card-body">
