    ...
    <div class="isolate bg-white">
        ...
        <div class="px-6 py-4 lg:px-10">
            <div>
                ...
                <div class="font-medium normal-case text-2xl pl-10 py-5">Magang</div>
                <div class="pt-2 relative mx-auto text-gray-600 pl-10">
                    <input class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-full w-80 text-sm focus:outline-none" type="search" name="search" placeholder="Cari Lowongan Magang">
        ...
        <main>
            <div class="px-20 py-10">
                <div class="grid grid-cols-3 gap-4 font-sans">
                    <div class="card w-96 bg-base-100 shadow-xl border p-5">
                        <div class="card">
                            ...
                            <h2 class="card-title">Copy Writer Intern</h2>
                            <p class="mb-5"><b>Jakarta, Indonesia |</b> paid</p>
                            <div class="flex space-x-2 mb-5">
                                <div style="background-color:#81B29A" class="badge badge-lg border-none">Fresh Graduate</div>
                                <div style="background-color:grey" class="badge badge-lg border-none">6 bulan</div>
                            </div>
                            <div style="background-color:#1D3557" class="badge badge-lg border-none w-full">
                                <div class="flex">
                                    <p class="absolute bottom-0 left-3">Deadline</p>
                                    <p class="absolute bottom-0 right-3">27 Desember 2022</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card w-96 bg-base-100 shadow-xl border p-5">
                        <div class="card">
                            ...
                            <h2 class="card-title">UI/UX Intern</h2>
                            <p class="mb-5"><b>Bandung, Indonesia |</b> unpaid</p>
                            <div class="flex space-x-2 mb-5">
                                <div style="background-color:#81B29A" class="badge badge-lg border-none">Min. Semester 5</div>
                                <div style="background-color:grey" class="badge badge-lg border-none">3 bulan</div>
                            </div>
                            <div style="background-color:#1D3557" class="badge badge-lg border-none w-full">
                                <div class="flex">
                                    <p class="absolute bottom-0 left-3">Deadline</p>
                                    <p class="absolute bottom-0 right-3">30 November 2022</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card w-96 bg-base-100 shadow-xl border p-5">
                        <div class="card">
                            ...
                            <h2 class="card-title">Specialist Social Media Intern</h2>
                            <p class="mb-5"><b>Malaysia |</b> paid </p>
                            <div class="flex space-x-2 mb-5">
                                <div style="background-color:#81B29A" class="badge badge-lg border-none">Fresh Graduate</div>
                                <div style="background-color:grey" class="badge badge-lg border-none">3 bulan</div>
                            </div>
                            <div style="background-color:#1D3557" class="badge badge-lg border-none w-full">
                                <div class="flex">
                                    <p class="absolute bottom-0 left-3">Deadline</p>
                                    <p class="absolute bottom-0 right-3">7 Januari 2023</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card w-96 bg-base-100 shadow-xl border p-5">
                        <div class="card">
                            ...
                            <h2 class="card-title">Data Analysist</h2>
                            <p class="mb-5"><b>Jakarta, Indonesia |</b> unpaid</p>
                            <div class="flex space-x-2 mb-5">
                                <div style="background-color:#81B29A" class="badge badge-lg border-none">Min. Semester 4</div>
                                <div style="background-color:grey" class="badge badge-lg border-none">6 bulan</div>
                            </div>
                            <div style="background-color:#1D3557" class="badge badge-lg border-none w-full">
                                <div class="flex">
                                    <p class="absolute bottom-0 left-3">Deadline</p>
                                    <p class="absolute bottom-0 right-3">24 Desember 2022</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card w-96 bg-base-100 shadow-xl border p-5">
                        <div class="card">
                            ...
                            <h2 class="card-title">Copy Writer Intern</h2>
                            <p class="mb-5"><b>Australia |</b> paid</p>
                            <div class="flex space-x-2 mb-5">
                                <div style="background-color:#81B29A" class="badge badge-lg border-none">Fresh Graduate</div>
                                <div style="background-color:grey" class="badge badge-lg border-none">2 bulan</div>
                            </div>
                            <div style="background-color:#1D3557" class="badge badge-lg border-none w-full">
                                <div class="flex">
                                    <p class="absolute bottom-0 left-3">Deadline</p>
